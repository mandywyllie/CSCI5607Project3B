...
In the current version of the raytracer, any object blocking a light creates a shadow. If we change it so that transmissive objects only dim the lights by their transmissive color, the same scene file gives us the image below.

<image src="myExampleScenes/nested_sphere_partial_shadows.png" style="width: 90%;"></image>
